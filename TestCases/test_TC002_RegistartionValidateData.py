...
def testValidateRegistration():
    ...
    #driver.find_element_by_name("fld_email").send_keys("romesh.bajaj@gmail.com")
    driver.find_element_by_name(ReadConfigFile.RegistrationPageData('Registration','Email')).send_keys("romesh.bajaj@gmail.com")
